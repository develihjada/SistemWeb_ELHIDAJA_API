...
@AllArgsConstructor
@NoArgsConstructor
public  class DocumentoIdentidadCreateDTO {
    ...
    @Min(value = 1, message = "El documento tiene que tener una lontigud")
    private Integer longitud;

    @NotBlank(message = "El mensaje de error no puede estar vacío")
    private String mensajeError;

    @NotNull(message = "Debe especificar el id de la nacionalidad")
